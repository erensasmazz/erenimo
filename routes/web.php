...
// Google Drive sayfası - Shopify session gerektirir
Route::get('google-drive-app', function () {
    return Inertia::render('google-drive-app');
})->middleware(['verify.shopify'])->name('google-drive-app');
